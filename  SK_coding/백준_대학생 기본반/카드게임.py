...
if card_color[0] == card_color[4] and card_num[0] == card_num[1]-1 and card_num[1] == card_num[2]-1 and card_num[2] == card_num[3]-1 and card_num[3] == card_num[4]-1:
...
elif card_color[0] == card_color[4]:
